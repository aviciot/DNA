  ...
  "templates": [
    {
      ...
      "sections": [
        ...
        {"id":"s6","number":"6","title":"Procedures","type":"numbered_section","subsections":[{"id":"s6_1","number":"6.1","title":"Risk Assessment","content":"{{organization_name}} shall conduct risk assessments per {{risk_methodology}}.","iso_reference":"6.1.2"}]}
      ],
