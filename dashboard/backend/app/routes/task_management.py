...
class TaskCreate(BaseModel):
    ...
    task_type: str
    task_scope: str  # 'customer', 'plan', 'document', 'question'
    title: str
    ...
    try:
        async with pool.acquire() as conn:
            ...
            """,
                ...
                task.manual_task_context, 'pending'
            )
        ...
        async with pool.acquire() as conn:
            ...
            rows = await conn.fetch(f"""
                SELECT
                    ...
                    ct.created_at, ct.completed_at, ct.is_ignored, ct.ignore_reason
